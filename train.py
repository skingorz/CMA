...
def setup_cfg(args):
    ...
    cfg.CoCMA.WEIGHT=args.lambd

    # 4. From optional input arguments
    cfg.merge_from_list(args.opts)

    if cfg.CMA.WEIGHT == -1.0:
        if cfg.DATASET.NUM_SHOTS == 1:
            cfg.CMA.WEIGHT = cfg.CMA.SHOT1
        elif cfg.DATASET.NUM_SHOTS == 2:
            cfg.CMA.WEIGHT = cfg.CMA.SHOT2
        elif cfg.DATASET.NUM_SHOTS == 4:
            cfg.CMA.WEIGHT = cfg.CMA.SHOT4
        elif cfg.DATASET.NUM_SHOTS == 8:
            cfg.CMA.WEIGHT = cfg.CMA.SHOT8
        elif cfg.DATASET.NUM_SHOTS == 16:
            cfg.CMA.WEIGHT = cfg.CMA.SHOT16
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lambd", type=float, default=0, help="lambda for MI")
